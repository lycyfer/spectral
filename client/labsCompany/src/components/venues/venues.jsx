...
const Venus = ({ items }) => {
  const [halls, setHalls] = useState([items]);
  ...
  return (
    <div className="venus">
      <div className="venus-right">
        <div className="venus-cards">
          {items.map((item) => (
            <div className="venus-cards-block" key={item.id}>
              <img className="card-img" src={item.imageUrls[0]} alt="" />
              ...
              <div className="card-info-block">
                <div className="cards-header-capacity">
                  ...
                  <div className="capacity-counter">{item.maxCapacity}</div>
                </div>
                <div className="ladder">Ladder {item.floor}</div>
              </div>
              <div className="card-price">Стоимость от {item.price} ₽/чел.</div>
              <button
